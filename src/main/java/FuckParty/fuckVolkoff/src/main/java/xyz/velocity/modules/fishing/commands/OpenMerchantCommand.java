...
public class OpenMerchantCommand extends ChildCommand {
    ...
    protected boolean noChildrenExecute(CommandSender commandSender, String string, String[] args) {
        ...
        Inventory inv = Bukkit.createInventory(null, FishingConfig.getInstance().inventory.getSize(), VelocityFeatures.chat(FishingConfig.getInstance().inventory.getGuiName()));
