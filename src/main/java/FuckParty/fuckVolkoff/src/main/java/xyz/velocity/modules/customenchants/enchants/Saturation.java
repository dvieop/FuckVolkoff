...
@Enchant
public class Saturation extends AbstractEnchant {
    ...
    public Saturation() {
        ...
        EnchantSave enchant = new EnchantSave(true, "Saturation", "&bSaturation", Arrays.asList("&7Constantly replenishes your hunger!"), "HELMET", "SATURATION:<level>", 1, 1, 50, 1, false, new JsonObject());
