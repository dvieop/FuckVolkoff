...
@EnchantItem
public class ShadowRealmOrb extends AbstractEnchantItem {

    private final CustomEnchantConfig config;

    public ShadowRealmOrb() {

        this.config = CustomEnchantConfig.getInstance();

        EnchantItemSave item = new EnchantItemSave(true, "shadowrealm", "&f&lAbility Orb: &7&lShadow Realm", Arrays.asList("Drag your opponent into sudden doom"), Arrays.asList(""), "MAGMA_CREAM", 0, true, this.extraInfo());
