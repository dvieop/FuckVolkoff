...
public class AddLevelSubCommand extends ChildCommand {
    ...
    protected boolean noChildrenExecute(CommandSender commandSender, String string, String[] args) {
        ...
        statsSave.setLevel(statsSave.getLevel() + level);
    ...
    public List<String> getAliases() {
        return Arrays.asList("addlevel");
    }

    @Override
    protected void sendUseMessage(CommandSender commandSender, String string, String[] args) {
        commandSender.sendMessage(VelocityFeatures.chat(MainConfig.getInstance().commandPrefix + "/safari addlevel <player> <amount>"));
    }
