...
@Item
public class SpeedOrb extends AbstractItem {
    ...
    public SpeedOrb() {
        ...
        ItemSave item = new ItemSave(false, "speed_orb", "&b&lSpeed Orb", "SUGAR", 0, new ArrayList<>(Collections.singleton("Gain speed 3")), new ArrayList<>(Collections.singleton("SPEED:2")), 60, this.extraInfo());
