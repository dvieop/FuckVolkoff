...
@EnchantItem
public class CursedMark extends AbstractEnchantItem {
    ...
    public CursedMark() {
        ...
        EnchantItemSave item = new EnchantItemSave(true, "cursedmark", "&f&lAbility Orb: &f&lCursed Mark", Arrays.asList("Mark your opponent for death"), Arrays.asList(""), "MAGMA_CREAM", 0, true, this.extraInfo());
