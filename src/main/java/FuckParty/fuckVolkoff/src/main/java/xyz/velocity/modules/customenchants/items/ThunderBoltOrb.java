...
@EnchantItem
public class ThunderBoltOrb extends AbstractEnchantItem {

    private final CustomEnchantConfig config;

    public ThunderBoltOrb() {

        this.config = CustomEnchantConfig.getInstance();

        EnchantItemSave item = new EnchantItemSave(true, "thunderbolt", "&f&lAbility Orb: &f&lThunder Bolt", Arrays.asList("Strike your enemies causing them slowness and weakness"), Arrays.asList(""), "MAGMA_CREAM", 0, true, this.extraInfo());
