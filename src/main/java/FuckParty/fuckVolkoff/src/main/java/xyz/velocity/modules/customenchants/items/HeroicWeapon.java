...
@EnchantItem
public class HeroicWeapon extends AbstractEnchantItem {
    ...
    public HeroicWeapon() {
        ...
        EnchantItemSave item = new EnchantItemSave(true, "heroic_weapon", "&d&lHeroic Upgrade &7(Weapon)", Arrays.asList("Enhance your weapon with heroic upgrade"), Arrays.asList(""), "NETHER_STAR", 0, true, this.extraInfo());
    ...
    public <T extends Event> void runTask(T event) {
        ...
        String compound = "velocity_enchantItem_heroicWeapon";
    ...
    private JsonObject extraInfo() {
        ...
        info.addProperty("displayName", "&5&k|||&d&l Heroic &5&k|||&d <original>");
        info.addProperty("damageMulti", 1.05);
