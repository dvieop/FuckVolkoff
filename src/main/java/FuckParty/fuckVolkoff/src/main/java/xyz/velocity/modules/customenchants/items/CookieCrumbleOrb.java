...
@EnchantItem
public class CookieCrumbleOrb extends AbstractEnchantItem {

    private final CustomEnchantConfig config;

    public CookieCrumbleOrb() {

        this.config = CustomEnchantConfig.getInstance();

        EnchantItemSave item = new EnchantItemSave(true, "cookiecrumble", "&f&lAbility Orb: &6&lCookie Crumble", Arrays.asList("Remove your opponents hunger"), Arrays.asList(""), "MAGMA_CREAM", 0, true, this.extraInfo());
