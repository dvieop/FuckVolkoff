...
@EnchantItem
public class EmpressOrb extends AbstractEnchantItem {
    ...
    public EmpressOrb() {
        ...
        EnchantItemSave item = new EnchantItemSave(true, "empress", "&f&lAbility Orb: &d&lEmpress", Arrays.asList("Gain invincibility for a short time"), Arrays.asList(""), "MAGMA_CREAM", 0, true, this.extraInfo());
