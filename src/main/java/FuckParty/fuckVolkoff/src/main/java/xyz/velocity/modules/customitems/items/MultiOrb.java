...
@Item
public class MultiOrb extends AbstractItem {
    ...
    public MultiOrb() {
        ...
        ItemSave item = new ItemSave(false, "multi_orb", "&a&lMulti Orb", "MAGMA_CREAM", 0, new ArrayList<>(Collections.singleton("Gain speed and strength")), new ArrayList<>(Collections.singleton("SPEED:2")), 60, this.extraInfo());
