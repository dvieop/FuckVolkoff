...
@EnchantItem
public class WhiteScroll extends AbstractEnchantItem {
    ...
    public WhiteScroll() {
        ...
        EnchantItemSave item = new EnchantItemSave(true, "white_scroll", "&f&lWhite Scroll", Arrays.asList("Put this item on your armor to protect it"), Arrays.asList("** PROTECTED **"), "PAPER", 0, false, this.extraInfo());
    ...
    public <T extends Event> void runTask(T event) {
        ...
        String compound = "velocity_enchantItem_whiteScroll";
        ...
        if (enchantItemCompound.getBoolean("protected")) return;
        enchantItemCompound.setBoolean("protected", true);
