...
@Item
public class GolemSkin extends AbstractItem {
    ...
    public GolemSkin() {
        ...
        ItemSave item = new ItemSave(false, "golem_skin", "&f&lGolem Skin", "IRON_INGOT", 0, new ArrayList<>(Collections.singleton("Gives temporary resistance")), new ArrayList<>(Collections.singleton("DAMAGE_RESISTANCE:1")), 60, this.extraInfo());
