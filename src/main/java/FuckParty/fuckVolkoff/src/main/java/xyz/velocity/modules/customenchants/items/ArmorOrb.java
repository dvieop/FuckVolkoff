...
@EnchantItem
public class ArmorOrb extends AbstractEnchantItem {
    ...
    public ArmorOrb() {
        ...
        EnchantItemSave item = new EnchantItemSave(true, "armor_orb", "&c&lArmor Orb", Arrays.asList("Increase enchant size by 1"), Arrays.asList("&4&l(&c&l!&4&l) &c&lSlot Upgrade"), "EMERALD", 0, false, this.extraInfo());
    ...
    public <T extends Event> void runTask(T event) {
        ...
        String compound = "velocity_enchantItem_armorOrb";
        ...
        if (enchantItemCompound.getInteger("slots") != null && enchantItemCompound.getInteger("slots") >= 1) return;
        enchantItemCompound.setInteger("slots", 1);
